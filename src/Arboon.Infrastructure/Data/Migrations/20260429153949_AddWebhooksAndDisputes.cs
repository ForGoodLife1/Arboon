...
{
    /// <inheritdoc />
    public partial class AddWebhooksAndDisputes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscrowId = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    OpenedBy = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WebhookEndpoints_Users_SellerId",
                        column: x => x.SellerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscrowId = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebhookDeliveries_IsFailed_Attempts",
                table: "WebhookDeliveries",
                columns: new[] { "IsFailed", "Attempts" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebhookEndpoints_SellerId_IsActive",
